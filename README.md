...
└── data/
    └── README.md
Files
	•	seizure_analysis.Rmd — Complete R Markdown source code and analysis.
	•	seizure_analysis.html — Rendered HTML version of the analysis and results.
	•	README.md — Project overview, methodology, and key findings.
	•	data/README.md — Information about the dataset and why the original dataset is not included.
About This Project
This project was completed as part of my Data Science coursework at Seattle Pacific University.
It gave me practical experience with model selection, feature engineering, clustering, hyperparameter tuning, classification metrics, and interpreting machine learning results.
I am continuing to build on these skills through additional machine learning and deep learning projects.
